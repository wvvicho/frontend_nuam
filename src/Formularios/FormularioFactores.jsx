    ...
    const manejarSubmit = (e) => {
        ...
        const FactoresInput = (key, label) => (
            <div className="d-flex align-items-center justify-content-between" key={key}>
                <label htmlFor={key} className="col-sm-6 col-form-label">{label}</label>
                <input type="number" name={key} id={key} className="form-control form-control-xs" value={factores[key]} onChange={e => manejarCambioFactor(key, e.target.value)}/>
            </div>
        );
                ...
                <div className="d-flex flex-wrap justify-content-between">
                    ...
                    <div className="d-flex flex-column gap-2 col-4 pe-3">
                        ...
                        <div className="d-flex align-items-center justify-content-between">
                            <label htmlFor="mercado" className="col-sm-4 col-form-label">Mercado</label>
                            <select name="mercados" id="mercados" className="form-select form-control-sm" value={mercado} onChange={(e) => setMercado(e.target.value)}>
                        ...
                        {/*Fecha_pago*/}
                        <div className="d-flex align-items-center justify-content-between">
                            <label htmlFor="fecha_pago" className="col-sm-4 col-form-label">Fecha Pago</label>
                            <input type="date" name="fecha_pago" id="fecha_pago" className="form-control form-control-sm" value={fecha_pago} onChange={(e) => setFechaPago(e.target.value)}/>
                        </div>
                        {/*Año*/}
                        <div className="d-flex align-items-center justify-content-between">
                            <label htmlFor="anio" className="col-sm-4 col-form-label">Año</label>
                            <input type="number" step={1} onKeyDown={manejarInt} name="anio" id="anio" className="form-control form-control-sm" value={anio} onChange={(e) => setAnio(e.target.value)}/>
                        </div> 
                    </div>
                    ...
                    <div className="d-flex flex-column gap-2 col-4 pe-3">
                        {/*Instrumento*/}
                        <div className="d-flex align-items-center justify-content-between">
                            <label htmlFor="instrumento" className="col-sm-4 col-form-label">Instrumento</label>
                            <input type="text" name="instrumento" id="instrumento" className="form-control form-control-sm" value={instrumento} onChange={(e) => setInstrumento(e.target.value)}/>
                        </div>
                        {/*Descripción*/}
                        <div className="d-flex align-items-center justify-content-between align-self-start w-100">
                            ...
                            <textarea name="descripcion" id="descripcion" className="form-control form-control-sm" value={descripcion} onChange={(e) => setDescripcion(e.target.value)}/>
                        </div>
                        {/*Ingreso por montos*/}
                    ...
                    <div className="d-flex flex-column gap-2 col-4">
                        {/*Valor histórico*/}
                        <div className="d-flex align-items-center justify-content-between">
                            <label htmlFor="valor_historico" className="col-sm-4 col-form-label">Valor Histórico</label>
                            <input type="number" name="valor_historico" id="valor_historico" className="form-control form-control-sm" value={valor_historico} onChange={(e) => setValorHistorico(e.target.value)}/>
                        </div>
                        {/*Secuencia evento*/}
                        <div className="d-flex align-items-center justify-content-between">
                            <label htmlFor="secuencia_evento" className="col-sm-4 col-form-label">Secuencia Evento</label>
                            <input type="number" step={1} onKeyDown={manejarInt} name="secuencia_evento" id="secuencia_evento" className="form-control form-control-sm" value={secuencia_evento} onChange={(e) => setSecuenciaEvento(e.target.value)}/>
                        </div>
                    </div>
                </div>
                <hr />
